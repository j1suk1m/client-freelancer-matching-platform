...
public final class MemberServiceInputMapper {
    ...
    public static MemberCreateInput toCreateMemberInput(String memberCode, MemberCreateRequest request) {
        return new MemberCreateInput(memberCode, request.name(), request.phoneNumber(),request.birthDate(),request.gender());
    }

    public static MemberUpdateInput toUpdateMemberInput(String memberCode, MemberUpdateRequest request) {
        return new MemberUpdateInput(memberCode, request.name(), request.phoneNumber(),request.birthDate(), request.gender());
    }

    public static MemberUpdateWorkStateInput toUpdateMemberWorkStateInput(String memberCode) {
        return new MemberUpdateWorkStateInput(memberCode);
    }
